...
Так как поверх QR-кода нанесено много надписей, он не считается. В качестве самого простого способа можно переисовать QR-код в любом графическом редакторе.
